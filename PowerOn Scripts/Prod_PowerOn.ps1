...
Import-Csv -Path C:\temp\Prodpowerstate_report_$CurrentDate.csv |
...
$msg.Subject = "Notification for the Production Servers PowerOn"
$msg.Body = "Attached is the Production powerOn report "
