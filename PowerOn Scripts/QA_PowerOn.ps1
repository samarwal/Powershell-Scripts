...
Import-Csv -Path C:\temp\QApowerstate_report_$CurrentDate.csv |
...
$msg.Subject = "Notification for the Quality Assurance Servers PowerOn"
$msg.Body = "Attached is the QA powerOn report "
